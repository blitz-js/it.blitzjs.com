        ...
        <div className="grid px-6 mx-auto max-w-7xl lg:grid-cols-3 gap-x-24 my-14 lg:mt-24 lg:mb-12 gap-y-7">
          <div className="flex flex-col justify-between space-y-7">
            <p className="text-lg font-semibold">
              Vuoi ricevere gli ultimi aggiornamenti e novità dal team Blitz? Iscriviti alla nostra
              newsletter!
            </p>
          ...
          <div className="flex flex-col justify-between space-y-7 lg:col-span-2">
            <div className="grid gap-7 md:grid-cols-3">
              <LinkList title="Documentazione">
                <Link href="/docs">
                  <a>Tutti i documenti</a>
                </Link>
                <Link href="/docs/get-started">
                  <a>Iniziare</a>
                </Link>
                <Link href="/docs/contributing">
                  <a>Come contribuire</a>
                </Link>
              </LinkList>
            ...
            >
              <Link href="https://vercel.com/?utm_source=blitzjs">
                <a target="_blank" rel="noopener noreferrer">
                  Hosted su <IoLogoVercel className="inline" /> Vercel
                </a>
              </Link>
              <br />
              Copyright &copy; {new Date().getFullYear()} Brandon Bayer e Blitz.js Contributors
            </div>
          </div>
        </div>
      </div>
