...
installazione. Se non lo è, avrai un errore sul tipo di “command not
found: blitz”.

## Creare una nuova applicazione {#creating-a-new-app}

Dalla riga di comando, `cd` all'interno della directory in cui vorresti
creare la tua applicazione e quindi lancia il seguente comando:
