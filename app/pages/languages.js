    ...
    <div className="relative py-1 md:py-3 min-h-screen bg-white dark:bg-purple-deep">
      ...
      <main className="mx-auto max-w-7xl px-6 py-24 xl:py-36 text-black dark:text-dark-mode-text space-y-16 lg:space-y-20">
        <div className="space-y-6">
          <h1 className="font-primary text-3xl lg:text4xl xl:text-5xl font-semibold">Lingue</h1>
          <p className="font-secondary text-lg text-gray-600 dark:text-gray-300">
            La documentazione di Blitz è attualmente in fase di traduzione nelle seguenti lingue:
          </p>
        </div>
        ...
        <div className="font-secondary text-base text-gray-600 dark:text-gray-300">
          ...
          <a
            ...
            className="text-purple-light dark:text-purple-extralight font-medium dark:font-bold no-underline dark:underline hover:underline"
          >
            Scopri come iniziare una nuova traduzione
          </a>
        </div>
      </main>
...
LanguagesPage.meta = {
  title: "Lingue - Blitz.js",
  description: ` Blitz è un framework React fullstack costruito su Node.js e offre un data layer "Zero-API" Blitz is a hyper-productive fullstack React framework that's built on Next.js and features a "Zero-API" data layer.`,
}
